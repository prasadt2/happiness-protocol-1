 ...
 * If we implement them in Brt's constructor, they can be dynamic.
 * e.g.: constructor(string memory name_, string memory symbol_) ERC20(name_, symbol_) {}
 */
contract BRT is ERC20("Brt", "BRT"), Ownable {
    // Public
    string public model;
    ...
    function mint(address account, uint256 amount) public onlyOwner {
         ...
         *   ✅ Your function can be called by contracts that inherit from yours (like BRT does with ERC20).
         */
